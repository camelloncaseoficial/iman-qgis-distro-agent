...
- [reference_build_environment.md](reference_build_environment.md) — ambiente local: OSGeo4W/python-qgis-ltr, ISCC path, verde IMAN real #00A858, conta gh franciscocamellon.
