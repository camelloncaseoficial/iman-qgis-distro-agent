...
- [reference_qgis_profile_and_packaging.md](reference_qgis_profile_and_packaging.md) — paths de perfil no Windows, launcher, Inno Setup, limites do no-fork vs. fork.
- [reference_build_environment.md](reference_build_environment.md) — bancada local (re-verificada 2026-09-01): QGIS standalone 3.44.13, Inno Setup 7.1.0 em Program Files (nenhum Inno 6), como a versao do ISCC 7 e medida, paleta oficial, conta gh franciscocamellon.
